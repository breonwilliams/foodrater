...
interface Notification {
    ...
    timestamp: string;
    isRead: boolean;
    actionType?: 'navigate_to_progress' | 'navigate_to_goals';
...
const sampleNotifications: Notification[] = [
    ...
    },
    {
        ...
        type: 'tip',
        title: 'Pro Tip',
        description: 'Try adding more vegetables to boost your nutrition score! 🥬',
    ...
    },
    {
        ...
        type: 'goal_progress',
        title: 'Quality Check',
        description: 'Your average food rating this week is 7.8 - excellent work! ⭐',
    ...
    },
    {
        ...
        description: '7-day tracking streak unlocked! 💪',
    ...
    },
    {
        ...
        description: '89% goal achievement rate in June! Incredible! 🎯',
...
export const NotificationsScreen = () => {
    ...
    const handleNotificationPress = (notification: Notification) => {
        ...
        if (notification.actionType === 'navigate_to_progress') {
            // Navigate back to main tabs and then to Progress tab
            navigation.navigate('MainTabs', { screen: 'Progress' });
        } else if (notification.actionType === 'navigate_to_goals') {
            // Navigate back to main tabs and then to HealthGoals tab
            navigation.navigate('MainTabs', { screen: 'HealthGoals' });
        }
    };
    ...
    const renderNotification = (notification: Notification, isLast: boolean) => (
        ...
        >
            <View style={styles.timelineContainer}>
                <View style={[styles.iconCircle, { backgroundColor: notification.iconColor }]}>
                    <Ionicons
